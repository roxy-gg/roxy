...
async function main(): Promise<void> {
  ...
  check('dictation mode defaults fast', repo.getSettings().dictationMode === 'fast')
  repo.setDictationMode('accurate')
  check('setDictationMode persists', repo.getSettings().dictationMode === 'accurate')
  repo.setDictationMode('fast')
  check('dictation polish defaults off', repo.getSettings().dictationPolish === false)
  repo.setDictationPolish(true)
  check('setDictationPolish persists', repo.getSettings().dictationPolish === true)
  repo.setDictationPolish(false)
